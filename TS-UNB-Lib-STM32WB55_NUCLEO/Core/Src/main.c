...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOC, LL_GPIO_PIN_0|LL_GPIO_PIN_5);

  /**/
  LL_GPIO_ResetOutputPin(GPIOB, LL_GPIO_PIN_2|LD2_Pin|LD3_Pin|LD1_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOE, LL_GPIO_PIN_4);

  /**/
  LL_GPIO_SetOutputPin(GPIOA, CLICK_1_RST_Pin|CLICK_1_CS_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = CLICK_1_RST_Pin|CLICK_1_CS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  ...
  /**/
  GPIO_InitStruct.Pin = LL_GPIO_PIN_2|LD2_Pin|LD3_Pin|LD1_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_DOWN;
